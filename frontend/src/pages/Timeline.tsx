                          ...
                          {group.items.map((task, index) => {
                            ...
                            return (
                              <div key={task.id} className="contents">
                                <div
                                  className={`flex h-[68px] flex-col justify-center border-r border-slate-200 px-6 py-3 ${rowBorderClass}`}
                                >
                                  <div className="flex items-start justify-between gap-3">
                                    <div>
                                ...
                                <div
                                  className={`relative h-[68px] border-l border-slate-200 ${rowBorderClass}`}
                                >
                                  <div
